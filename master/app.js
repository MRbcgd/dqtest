...
io.sockets.on('connection', function(socket) {
	...
	socket.on('wm', function (message) {
		console.log('####################');
		console.log('Receive packet from web');
		console.log(message);
		console.log('####################');

		//MORE SVRKEY WILL BE SUPPLY
		if ( message.head.dstkey === svrkey ) {
		...
		//NO SERVER
			...
			message.error.mesg = 'Incorrect packet data';
	...
	socket.on('am', function (message) {
		console.log('####################');
		console.log('Receive packet from agent');
		console.log(message);
...
//#########################################################################################################
	socket.on('db_query', function (message) {
		...
		console.log('####################');
		console.log('Receive packet from agent'); console.log(message);
		if ( message.head.svrkey === svrkey) {
			...
			if ( message.head.svccd === 'stat_prcs') {
				...
				") VALUES (" +
					"'" + svrkey + "', " +
					"'" + message.output.cpu.date +"', " +
					""  + message.output.cpu.us + ", " +
					"'" + message.output.cpu.prcs1_nm + "', " +
					message.output.cpu.prcs1_us + ", " +
					"'" + message.output.cpu.prcs2_nm + "', " +
					message.output.cpu.prcs2_us + ", " +
					"'" + message.output.cpu.prcs3_nm + "', " +
					message.output.cpu.prcs3_us + " " +
				")";
