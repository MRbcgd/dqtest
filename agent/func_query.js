...
module.exports.getWorldTime = function(tzOffset) { //KST
  var now = new Date();
  ...
  var s =
    exports.leadingZeros(now.getFullYear(), 4) + '-' +
    exports.leadingZeros(now.getMonth() + 1, 2) + '-' +
    exports.leadingZeros(now.getDate(), 2) + ' ' +

    exports.leadingZeros(now.getHours(), 2) + ':' +
    exports.leadingZeros(now.getMinutes(), 2) + ':' +
    exports.leadingZeros(now.getSeconds(), 2);
